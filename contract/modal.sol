...
contract T__T is Context, IERC20, Ownable {

    uint256 private constant _totalSupply = T__V;
    uint8 private constant _decimals = T__D;
    string private constant _name = "T__N";
    string private constant _symbol = "T__S";
