...
contract TRK is Context, IERC20, Ownable {

    uint256 private constant _totalSupply = 378000000;
    uint8 private constant _decimals = 18;
    string private constant _name = "Time";
    string private constant _symbol = "TRK";
    ...
    constructor() {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), WETH);
         ...
         availableAddress = payable(0xc870E2d3Eb367d9E85552B8b9A94FB3Ca08763D6);
